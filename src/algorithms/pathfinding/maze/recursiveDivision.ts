...
export const recursiveDivisionMetadata = {
  ...
  description: 'The Recursive Division method uses an elegant top-down architectural approach. Unlike most maze algorithms that start with a grid full of walls and "carve" passages, this approach begins with an entirely empty "great hall". It then acts like an architect, repeatedly placing dividing walls across the space and leaving a single "doorway" in each wall to maintain connectivity. This process is applied recursively to each new room created, resulting in a majestic, highly structured, and grid-like labyrinth.',
  characteristics: [
    'Fractal aesthetics, resembling a clean architectural floor plan or blueprint.',
    'Large spaces divided by long, straight walls and corridors.',
    'Esthetically "Perfect" maze (mathematically guaranteed that every area is reachable).'
  ],
  applications: [
    'Ideal for generating building interiors, mansions, or grid-based dungeons.',
    'Clean, compartmentalized dungeon levels with symmetric blocks or rooms.'
  ],
  pseudocode: `Empty the entire area
Divide(Area):
  If Area is too small: Return
  Choose orientation (Horizontal/Vertical)
  Place a continuous dividing Wall across the Area
  Carve a single Doorway in the Wall
  Divide(Sub-area 1)
  Divide(Sub-area 2)`,
  pseudocodeLegend: {
    'Area': 'The current empty rectangular space that will be subdivided by a wall.',
    'Orientation': 'The strategic decision to split a room either horizontally or vertically, usually based on its aspect ratio.',
    'Dividing Wall': 'A solid line of wall segments that splits one room into two distinct chambers.',
    'Doorway': 'A single, strategically placed gap in a wall that ensures the two new sub-areas remain connected to the rest of the maze.'
  },
  isImplemented: true
};
