    ...
    <div className="toolbar-noborder">
      ...
      <div className="flex items-center gap-2 flex-grow justify-center pl-8">
        <select
          ...
          className="form-select-primary uppercase"
        >
      ...
      <div className="flex items-center gap-4">
        <SpeedControl speed={speed} onSpeedChange={onSpeedChange} options={SORTING_SPEED_OPTIONS} />
        ...
        <div className="flex gap-6 pr-10">
          ...
          <UnderlineButton label="Reset" onClick={onReset} />
        </div>
      </div>
    </div>
  );
